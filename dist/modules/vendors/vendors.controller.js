...
let VendorsController = class VendorsController {
    ...
    claimIntent(req) {
        return this.vendorsService.claimVendorIntent(req.user.id);
    }
    getMyProfile(req) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        summary: 'Type the current account as a vendor (called on vendor-app sign-up). Refused for established clients.',
    }),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], VendorsController.prototype, "claimIntent", null);
__decorate([
    (0, common_1.Get)('me'),
    (0, common_1.UseGuards)(session_auth_guard_1.SessionAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({
        summary: 'Submit KYC documents (government ID, + business registration for registered businesses) for verification',
    }),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        summary: 'Browse verified vendors (public, DB-backed — no search dependency)',
    }),
    ...
    __metadata("design:returntype", void 0)
], VendorsController.prototype, "browse", null);
__decorate([
    (0, common_1.Get)(':id'),
