...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        enum: client_1.EventType,
        description: 'Filter to listings whose vendor serves this event type (vendors with no declared event types serve all)',
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(client_1.EventType),
    __metadata("design:type", String)
], SearchListingsDto.prototype, "eventType", void 0);
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        enum: client_1.EventType,
        description: 'Filter to vendors serving this event type (vendors with no declared event types serve all)',
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(client_1.EventType),
    __metadata("design:type", String)
], SearchVendorsDto.prototype, "eventType", void 0);
