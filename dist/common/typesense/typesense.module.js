...
const typesense_sync_service_1 = require("./typesense-sync.service");
...
exports.TypesenseModule = TypesenseModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [typesense_provider_1.TypesenseProvider, typesense_sync_service_1.TypesenseSyncService],
        exports: [typesense_provider_1.TypesenseProvider, typesense_sync_service_1.TypesenseSyncService],
    })
], TypesenseModule);
